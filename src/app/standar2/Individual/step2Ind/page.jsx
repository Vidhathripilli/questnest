...
function Step2Content() {
  ...
  const handleNext = () => {
    if (step <= 5) {
      router.push(`/standar2/step2Indprofile?step=${step + 1}&type=${selectedType}`);
    }
  };
      ...
      <div className="max-w-md bg-white shadow-none rounded-none p-0">
        <div className="text-center">
          ...
          <div className="mt-6 text-blue-500 text-sm">
            <p>Details from your profile will be used on all correspondence to your students/staff</p>
          </div>
